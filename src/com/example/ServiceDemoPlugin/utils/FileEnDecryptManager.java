package com.example.ServiceDemoPlugin.utils;
...
public class FileEnDecryptManager {
     ...
     * 记录上次解密过的文件名
     */
    private final String LastDecryptFile = "c:/decrypt/LastDecryptFilename.ttt";
    ...
    public static void main(String[] args) {
        // 测试加密
        boolean b = FileEnDecryptManager.getInstance().InitEncrypt("C:\\decrypt\\app_config.xml");
        System.out.println(b);
        FileEnDecryptManager.getInstance().decrypt("C:\\decrypt\\app_config.xml");
    }
}